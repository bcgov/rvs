...
#    && apt-get install -yq apt-utils zlib1g-dev g++ libicu-dev libzip-dev zip libpq-dev git nano netcat-traditional curl apache2 dialog locate libcurl4 libcurl3-dev psmisc \
#	libfreetype6-dev \
#    libjpeg62-turbo-dev \
#    libmcrypt-dev \
#    libpng-dev \
...
##RUN mkdir -p /opt/oracle && chmod -R ug+rwx /opt/oracle && chown -R ${USER_ID}:root /opt/oracle
#
...
#  && ldconfig
#
#RUN pear download pecl/oci8-3.2.1 && tar xvzf oci8-3.2.1.tgz && cd oci8-3.2.1 && phpize && ./configure --with-oci8=instantclient,$ORACLE_HOME/ && make install
#RUN printf "instantclient,$ORACLE_HOME" | pecl install oci8-3.2.1
#
#
## Download and install OCI8 extension
##RUN pear download pecl/oci8-3.2.1 && tar xvzf oci8-3.2.1.tgz && cd oci8-3.2.1 && phpize && ./configure --with-oci8=instantclient,$ORACLE_HOME/ && make
##RUN printf "instantclient,$ORACLE_HOME/" | pecl install oci8-3.2.1
#
#
#
