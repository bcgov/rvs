        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav flex-row flex-wrap ms-md-auto" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <NavLink class="nav-link" href="/restrictions"
...
export default {
    ...
    mounted() {
        if (this.$page.props.auth.roles != undefined) {
            for (let i = 0; i < this.$page.props.auth.roles.length; i++) {
                // console.log(this.$page.props.auth.roles[i].name.indexOf('Admin'));
                if (this.$page.props.auth.roles[i].name.indexOf('Admin') > -1) {
                    this.isAdmin = true;
                    break;
                }
            }
