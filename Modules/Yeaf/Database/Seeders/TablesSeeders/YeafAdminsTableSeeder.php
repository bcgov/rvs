...
class YeafAdminsTableSeeder extends Seeder
{
    public function run(): void
    {
        ...
        for ($i = 0; $i < 5; $i++) {
            $contactFname = $faker->firstName;
            $contactLname = $faker->lastName;

            DB::connection('yeaf')->table('admins')->updateOrInsert(
                [
                ...
                [
                    ...
                    'ministry_prov' => $faker->randomElement(['BC', 'AB', 'SK', 'MB', 'ON', 'QC', 'NB', 'NS', 'PE', 'NL']),
                    ...
                    'ministry_location' => $faker->buildingNumber . ' ' . $faker->streetName,
                    'ministry_location_city' => $faker->city,
                    'ministry_location_prov' => $faker->randomElement(['BC', 'AB', 'SK', 'MB', 'ON', 'QC', 'NB', 'NS', 'PE', 'NL']),
