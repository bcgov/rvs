    ...
    <table>
        ...
        <tr>
            <td>
                ...
                @switch($doc)
                    @case('rptLtrApproved')
                    @include('yeaf::letters.reptLtrApproved', compact('grant', 'admin', 'user', 'doc', 'student', 'officer', 'now_d', 'now_t'))
                    @break
                    @case('rptLtrPending')
                    @include('yeaf::letters.reptLtrPending', compact('grant', 'admin', 'user', 'doc', 'student', 'officer', 'now_d', 'now_t'))
                    @break
                    @case('rptLtrDenied')
                    @include('yeaf::letters.reptLtrDenied', compact('grant', 'admin', 'user', 'doc', 'student', 'officer', 'now_d', 'now_t'))
                    @break
                    @case('rptLtrApprovedSFASExtract')
                    @include('yeaf::letters.reptLtrApprovedSFASExtract', compact('grant', 'admin', 'user', 'doc', 'student', 'officer', 'now_d', 'now_t'))
                    @break
                    @case('rptLtrSuccessComp')
                    @include('yeaf::letters.reptLtrSuccessComp', compact('grant', 'admin', 'user', 'doc', 'student', 'officer', 'now_d', 'now_t'))
                    @break

                    @case('rptLtrWithdrawal')
                    @include('yeaf::letters.reptLtrWithdrawal', compact('grant', 'admin', 'user', 'doc', 'student', 'officer', 'now_d', 'now_t'))
                    @break
