...
<template>
    <nav class="navbar navbar-expand-lg navbar-dark shadow">
        <div class="container-fluid">
            <Link class="navbar-brand" href="/yeaf/students">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#YeafNavbarScroll" aria-controls="YeafNavbarScroll" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="YeafNavbarScroll">
                <ul class="navbar-nav flex-row flex-wrap ms-md-auto" style="--bs-scroll-height: 100px;">
                    <li class="nav-item">
                        <BreezeNavLink class="nav-link" href="/yeaf/students" :active="$page.url.indexOf('students') > -1">
                            Students
                        </BreezeNavLink>
                    </li>
                    <li class="nav-item">
                        <BreezeNavLink class="nav-link" href="/yeaf/institutions" :active="$page.url.indexOf('institutions') > -1">
                            Schools
                        </BreezeNavLink>
                    </li>
                    <li v-if="isAdmin" class="nav-item">
                        <BreezeNavLink class="nav-link" href="/yeaf/maintenance/ministry" :active="$page.url.indexOf('maintenance') > -1">
                            Maintenance
                        </BreezeNavLink>
                    </li>
