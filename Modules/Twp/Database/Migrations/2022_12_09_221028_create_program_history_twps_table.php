...
return new class extends Migration
{
    ...
    public function up()
    {
        if (! Schema::connection(env('DB_DATABASE_TWP'))->hasTable('program_histories')) {
            Schema::connection(env('DB_DATABASE_TWP'))->create('program_histories', function (Blueprint $table): void {
                $table->id();
                ...
                $table->foreign('program_twp_id')->references('id')->on('programs')->onDelete('cascade');
    ...
    {
        Schema::connection(env('DB_DATABASE_TWP'))->dropIfExists('program_histories');
    }
};
