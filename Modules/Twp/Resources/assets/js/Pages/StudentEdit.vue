                                ...
                                <div class="card-body">
                                    <ul>
                                        <li v-for="(app, i) in result.applications">
                                            ...
                                            <span v-if="app.application_status === 'APPROVED'" class="float-end badge rounded-pill text-bg-success">{{app.application_status}}</span>
                                            <span v-else-if="app.application_status === 'IN PROGRESS'" class="float-end badge rounded-pill text-bg-info">{{app.application_status}}</span>
                                            <span v-else-if="app.application_status === 'DENIED'" class="float-end badge rounded-pill text-bg-danger">{{app.application_status}}</span>
                                            <span v-else class="float-end badge rounded-pill text-bg-primary">{{app.application_status}}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
