<template>
    <div>
        <div v-for="cat in categories" class="card mb-3">
            <div class="card-header">
                <div>
                    ...
                    <button @click="newUtil(cat)" type="button" class="btn btn-success btn-sm float-end">New {{
                            cat
                        }}
                    </button>
                </div>
                ...
                <div v-if="results[cat] != null" class="table-responsive pb-3">
                    <table class="table table-striped">
                        ...
                        <tr v-for="(row, i) in results[cat]">
                            <td>
                                <button @click="editUtil(cat, i)" type="button" class="btn btn-link text-start"
                                        data-bs-toggle="modal" data-bs-target="#editUtilModal">{{ row.field_name }}
                                </button>
                            </td>
        ...
        <div class="modal modal-lg fade" id="newUtilModal" tabindex="-1" aria-labelledby="newUtilModalLabel"
                ...
                <div class="modal-content">
                    ...
                    <form v-if="newUtilForm != null" @submit.prevent="submitNewUtil">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <BreezeInput type="text" class="form-control" id="newUtilTitle"
                                                     v-model="newUtilForm.field_name"/>
                                    </div>
                                    <div class="col-md-3">
                                        <BreezeLabel for="newUtilActiveFlag" class="form-label" value="Active"/>
                                        <BreezeSelect class="form-select" id="newUtilActiveFlag"
                                                      v-model="newUtilForm.active_flag">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-sm btn-success" :disabled="newUtilForm.processing">
                                Submit
                            </button>
                        </div>
                    </form>
        ...
        <div class="modal modal-lg fade" id="editUtilModal" tabindex="-1" aria-labelledby="editUtilModalLabel"
             aria-hidden="true" data-bs-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form v-if="editUtilForm != null" @submit.prevent="submitEditUtil">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <BreezeInput type="text" class="form-control" id="editUtilTitle"
                                                     v-model="editUtilForm.field_name"/>
                                    </div>
                                    <div class="col-md-3">
                                        <BreezeLabel for="editUtilActiveFlag" class="form-label" value="Active"/>
                                        <BreezeSelect class="form-select" id="editUtilActiveFlag"
                                                      v-model="editUtilForm.active_flag">
                                            <option value="false">False</option>
                                            <option value="true">True</option>
                                        </BreezeSelect>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-sm btn-success" :disabled="editUtilForm.processing">
                                Update
                            </button>
                        </div>
                    </form>
...
export default {
    ...
    methods: {
        ...
        submitEditUtil: function () {
            this.editUtilForm.formState = '';
            this.editUtilForm.put('/twp/maintenance/utils/' + this.editUtilForm.id, {
                onSuccess: (response) => {
        ...
        submitNewUtil: function () {
            ...
            this.newUtilForm.post('/twp/maintenance/utils', {
                onSuccess: (response) => {
