...
class Program extends ModuleModel
{
    ...
    /**
     * @return BelongsTo<Student, Program>
     */
    ...
    /**
     * @return BelongsTo<Application, Program>
     */
    ...
    /**
     * @return BelongsTo<Institution, Program>
     */
    public function institution(): BelongsTo {
        return $this->belongsTo(Institution::class, 'institution_twp_id', 'id');
    }

    /**
     * @return HasMany<ProgramHistory>
     */
    public function versions(): HasMany {
        return $this->hasMany(ProgramHistory::class, 'program_twp_id', 'id')->orderBy('created_at', 'desc');
    }
}
