                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-header">
                            PLSCPS Applications Search
                        </div>
                        <div class="card-body">
                            <ApplicationSearchBox page="/plsc/applications/" />
                        </div>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <div class="d-flex float-end">
                                ...
                                <a href="/plsc/applications/sync" class="btn btn-success btn-sm">Sync Apps</a>
                            </div>
                            ...
                            <div v-if="results != null && results.data.length > 0" class="table-responsive pb-3">
                                <table class="table table-striped">
                                    ...
                                    <tr v-for="(row, i) in results.data">
                                        <td><Link :href="'/plsc/applications/show/' + row.id">{{ studentLastName(row.sfas_ind.last_name) }}</Link></td>
...
export default {
    ...
    methods: {
        ...
        newApplication: function () {
            ...
            this.newApplicationForm.post('/plsc/applications', {
                onSuccess: (response) => {
                    $("#newApplicationModal").modal('hide')
                        .on('hidden.bs.modal', function () {
                            ...
                            if(response.props.app > 0)
                                vm.$inertia.visit('/plsc/applications/show/' + response.props.app);
