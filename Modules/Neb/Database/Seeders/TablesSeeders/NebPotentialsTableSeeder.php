...
class NebPotentialsTableSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach (range(1, 50) as $index) {
            ...
            $applicationNumber = $faker->unique()->numberBetween(1000000, 9999999);
            $sin = $faker->unique()->numberBetween(100000000, 999999999);

            DB::connection('neb')->table('el_potentials')->updateOrInsert(
                ['application_number' => $applicationNumber, 'sin' => $sin],
                [
